            ...
            rows.append(
                {
                    ...
                    "seal_amount_wan_raw": item[4],
                    "seal_amount_wan_raw_wan": round(float(item[4]) / 10000, 2) if item[4] not in (None, "") else None,
                    "seal_amount_wan_raw_text": self._format_qxlive_amount(item[4], yi_digits=1, wan_digits=0) if item[4] not in (None, "") else "",
                    ...
                    "auction_turnover": item[8],
                    "auction_amount": item[9],
                    "auction_amount_wan": round(float(item[9]) / 10000, 2) if item[9] not in (None, "") else None,
                    "auction_turnover_dup": item[10],
                    "concept": concept_raw,
                    "concept_1": concept_1,
                    "concept_2": concept_2,
                    "free_float_mktcap": item[12],
                    "free_float_mktcap_yi": round(float(item[12]) / 100000000, 2) if item[12] not in (None, "") else None,
                    "free_float_mktcap_text": self._format_qxlive_amount(item[12], yi_digits=0, wan_digits=0) if item[12] not in (None, "") else "",
